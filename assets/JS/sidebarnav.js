...
// Membuat elemen div yang berisi kode HTML yang ingin Anda sisipkan
var div = document.createElement('div');
div.innerHTML = `<!-- sidebar konten --> 
         <header class="sidebar-header" class="bg-transparant px2 py1 m0 flex items-center white"> 
...
// Menambahkan elemen div ke dalam header
